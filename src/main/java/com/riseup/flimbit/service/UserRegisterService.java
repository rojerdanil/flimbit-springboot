...
public interface UserRegisterService {
	...
	public Page<UserWithStatusWebDto> fetchAllUsersWithStatus(int language,int movie,String status,String searchText, int start, int length,
    ...
    public SuccessResponse   verifyLanguage( long code);

    
	//
    
    public SuccessResponse   initiatePan( PanRequest emailRequest);
